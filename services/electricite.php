...
<head>
    ...
    <title>GC-Climelec • Electricite</title>
...
<body onload="insertTextElectricite();">
<div class="header">
    <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="./froid.php">Froid</a>
...
<script src="text/textElectricite.js"></script>
